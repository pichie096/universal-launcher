...
class MinecraftLauncher:
    ...
    def load_versions(self):
        ...
        try:
            ...
            installed_vanilla = [v['id'] for v in installed if 'forge' not in v['id'].lower() and 'fabric' not in v['id'].lower()]
    ...
    def load_loader_versions(self):
        ...
        try:
            ...
            if loader == "forge":
                ...
                try:
                    response = requests.get('https://files.minecraftforge.net/net/minecraftforge/forge/promotions_slim.json', timeout=5)
    ...
    def check_all_updates(self):
        ...
        try:
            ...
            vanilla_versions = [v['id'] for v in installed if 'forge' not in v['id'].lower() and 'fabric' not in v['id'].lower()]
            if vanilla_versions:
    ...
    def install_latest(self):
        ...
        if loader == "vanilla":
            messagebox.showinfo("Info", "Vanilla Minecraft doesn't have loader versions.\nUse 'Install Version' instead.")
            return
        ...
        try:
            ...
            if loader == "forge":
                ...
                if forge_versions:
                    ...
                    messagebox.showerror("Error", f"Forge for {version} is not installed.\nPlease install it first using 'Install Version' button.")
                    return
                ...
                if fabric_versions:
                    ...
                    messagebox.showerror("Error", f"Fabric for {version} is not installed.\nPlease install it first using 'Install Version' button.")
                    return
            else:
                ...
                if not vanilla_versions:
                    ...
                    messagebox.showerror("Error", f"Minecraft {version} is not installed.\nPlease install it first using 'Install Version' button.")
                    return
